...
----------------------------------------------------------------------------
CDMahjongHHLLKLlkItem = class( "CDMahjongHHLLKLlkItem", CDCCBLayer)
...
CDMahjongHHLLKLlkItem.m_pHHLLKEffBarrierSprite = nil     
...
function CDMahjongHHLLKLlkItem:initialMember()
    ...
    self.m_pHHLLKEffBarrierSprite = nil
end
...
----------------------------------------------------------------------------
-- 障碍物图片隐藏设置
function CDMahjongHHLLKLlkItem:setBarrierVisible(boolen)
    if self.m_pHHLLKEffBarrierSprite == nil then
        return
    end
    ...
    self.m_pHHLLKEffBarrierSprite:setVisible(boolen)
end
...
function CDMahjongHHLLKLlkItem:onAssignCCBMemberVariable(loader)
    ...
    self.m_pHHLLKEffBarrierSprite = loader["barrier_sprite"]
    return true
end
